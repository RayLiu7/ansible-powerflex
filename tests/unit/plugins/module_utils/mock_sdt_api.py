...
"""
Mock Api response for Unit tests of SDT module on Dell Technologies (Dell) PowerFlex
"""
...
class MockSDTApi:
    ...
    RESPONSE_EXEC_DICT = {
        ...
        "create_sdt_without_sdt_name": "Please provide valid sdt_name value for the creation of SDT.",
        "create_sdt_without_pd": "Protection Domain is a mandatory parameter",
        "create_sdt_without_sdt_ip_list": "Provide valid values for sdt_ip_list as 'ip' and 'role' for Create/Modify operations",
        "create_sdt_with_sdt_new_name": "sdt_new_name and maintenance_mode are not supported during SDT creation",
        "rename_sdt_empty_exception": "Provide valid value for name for the creation/modification of the SDT.",
